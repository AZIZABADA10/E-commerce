...
const ProductsPage = () => {
  ...
  const addToCart = (product) => {
    ...
    if (existingItem) {
      ...
      if (existingItem.quantity < product.stockQuantity) {
        ...
        toast.success(`Quantité de ${product.name} augmentée dans le panier !`);
      } else {
  ...
  return (
    <div className="container py-4">
      ...
      {/* Header avec compteur de panier */}
      <div className="d-flex justify-content-between align-items-center mb-4">
        <h1 className="text-primary">Mes Produits</h1>
            ...
            <div className="card h-100 product-card">
              ...
              <div className="card-body">
                ...
                {getCartQuantity(product._id) > 0 && (
                  <div className="mt-2">
                    <small className="text-info">Dans le panier: {getCartQuantity(product._id)}</small>
                  </div>
                )}
              </div>
